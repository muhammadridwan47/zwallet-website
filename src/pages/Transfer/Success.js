                            ...
                            <div className="col-12 col-sm-9" id="area">
                                <div className="body-area-success">
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="card-details ">
                                                <p>Amount</p>
                                                <h4>Rp {formatNumber(this.state.dataTransfer.amount)}</h4>
                                            </div>
                                        </div>
                                        <div className="col-12">
                                            <div className="card-details ">
                                                <p>Balance Left</p>
                                                <h4>Rp {formatNumber(this.state.dataTransfer.available)}</h4>
                                            </div>
                                        </div>
                                        <div className="col-12">
                                            <div className="card-details ">
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="d-sm-none">
                                              <CardPerson name={this.state.dataTransfer.name} photo={this.state.dataTransfer.photo} phone={this.state.dataTransfer.phone}/>
                                            </div>
                                    ...
                                    <div className="text-center text-sm-right mt-md-5">
                                        <button className="btn btn-share d-none d-sm-inline"><img alt="" src={icShare} /></button> &nbsp;&nbsp;
                                        <button className="btn btn-download d-none d-sm-inline"><img alt="" src={icDownload} />&nbsp; <span>Download PDF</span></button> &nbsp;&nbsp;
                                        <Link to="/dashboard">
